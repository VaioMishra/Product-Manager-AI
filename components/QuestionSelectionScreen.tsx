...
const QuestionSelectionScreen: React.FC<QuestionSelectionScreenProps> = ({ user, onQuestionSelect, onStartFullInterview }) => {
  const [mainTab, setMainTab] = useState<'new_session' | 'history'>('new_session');
  ...
  return (
    <div className="animate-fade-in space-y-8">
      <h2 className="text-3xl font-bold text-center">Hello, {user.name}! What's next?</h2>
      
      <Tabs tabs={mainTabs} activeTab={mainTab} onTabClick={(id) => setMainTab(id as any)} />
